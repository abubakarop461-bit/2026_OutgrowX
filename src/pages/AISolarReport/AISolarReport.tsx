    ...
    <main className="container mx-auto px-4 pt-20 pb-12">
      ...
      <div className="flex flex-row justify-between items-start md:items-end mb-8 gap-4">
        <div>
          ...
          <h1 className="text-3xl font-bold text-primary mb-1">Your AI Solar Intelligence Report</h1>
          <p className="text-gray-400">Personalized for {userProfile.firstName || 'You'} · {userProfile.state} · Generated {new Date().toLocaleDateString('en-IN')}</p>
        </div>
