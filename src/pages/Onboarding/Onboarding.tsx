          ...
          <div className="glass-card glass-card--lg" style={{ boxShadow: 'var(--shadow-glow)' }}>
            <h2 className="mb-1" style={{ fontSize: '1.5rem', fontFamily: 'Outfit, sans-serif', color: '#ECF2EE' }}>
              {isBusiness ? (
                ...
                <>
                  {currentStep === 1 && t('onboardingTitle1')}
                  {currentStep === 2 && t('onboardingTitle2')}
                  {currentStep === 3 && t('onboardingTitle3')}
                  {currentStep === 4 && t('onboardingTitle4')}
                  {currentStep === 5 && t('onboardingTitle5')}
                </>
              )}
            </h2>
            <p className="text-secondary mb-6" style={{ fontSize: '0.875rem', color: '#7A9484' }}>
              {isBusiness ? (
                ...
                <>
                  {currentStep === 1 && t('onboardingSubtitle1')}
                  {currentStep === 2 && t('onboardingSubtitle2')}
                  {currentStep === 3 && t('onboardingSubtitle3')}
                  {currentStep === 4 && t('onboardingSubtitle4')}
                  {currentStep === 5 && t('onboardingSubtitle5')}
                </>
              )}
            </p>
              ...
              {currentStep === 1 && (
                <div className="flex-col gap-6">
                  ...
                  <div className="form-group">
                    <label className="label" style={{ fontSize: '0.75rem', color: '#7A9484' }}>{t('iAmA')}</label>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '0.75rem' }}>
                      {[
                        { labelKey: 'homeowner', Icon: House, color: '#A8FF3E', role: 'consumer', defaultVal: 'Homeowner' },
                        { labelKey: 'landowner', Icon: Plant, color: '#60A5FA', role: 'landowner', defaultVal: 'Landowner' },
                        { labelKey: 'solarVendor', Icon: Buildings, color: '#F59E0B', role: 'business', defaultVal: 'Solar Vendor' }
                      ].map(({ labelKey, Icon, color, role, defaultVal }) => (
                        <button
                          key={labelKey}
                          type="button"
                          className={`toggle-option ${formData.userType === defaultVal || (defaultVal === 'Solar Vendor' && formData.userType === 'Business Owner') ? 'toggle-option--selected' : ''}`}
                          onClick={() => {
                            const targetType = defaultVal === 'Solar Vendor' ? 'Solar Vendor' : defaultVal;
                            update('userType', targetType);
                            if (defaultVal === 'Landowner') update('propertyType', 'Agricultural Land');
                            if (defaultVal === 'Homeowner') update('propertyType', 'Independent House');
                          }}
                          style={{ padding: '1.25rem 0.5rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.625rem' }}
                        >
                          <Icon size={26} weight="duotone" color={(formData.userType === defaultVal || (defaultVal === 'Solar Vendor' && formData.userType === 'Business Owner')) ? '#A8FF3E' : color} />
                          <span className="text-sm" style={{ fontWeight: 600 }}>{t(labelKey as any)}</span>
                        </button>
                      ))}
                    </div>
                  </div>
                  ...
                  {isBusiness ? (
                    <>
                      <div className="form-group">
                        <label className="label" htmlFor="companyName" style={{ fontSize: '0.75rem', color: '#7A9484' }}>{t('companyLegalName')}</label>
                        <input
                          type="text"
                          id="companyName"
                          className="input"
                      ...
                      <div className="form-group">
                        <label className="label" htmlFor="firstName" style={{ fontSize: '0.75rem', color: '#7A9484' }}>{t('contactPersonName')}</label>
                        <input
                          type="text"
                          id="firstName"
                          className="input"
                    ...
                    <div className="form-group">
                      <label className="label" htmlFor="firstName" style={{ fontSize: '0.75rem', color: '#7A9484' }}>{t('firstName')}</label>
                      <input
                        type="text"
                        id="firstName"
                        className="input"
              ...
              <div className="flex justify-between gap-4 mt-8">
                ...
                {currentStep < 5 ? (
                  ...
                  <button type="submit" className="btn btn-primary btn-lg flex-1 justify-center" style={{ fontSize: '0.9375rem' }}>
                    {isBusiness ? t('openInstallerPortal') : t('viewMyDashboard')} <ArrowRight size={16} />
                  </button>
                )}
              </div>
            </form>
        ...
        <div className="onboarding-preview-col flex-col gap-6" style={{ width: '400px' }}>
          {isBusiness ? (
            ...
            >
              ...
              <h4 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '1.125rem', fontWeight: 700, color: '#ECF2EE', marginBottom: '0.375rem' }}>
                {t('solarPossibilitiesTitle')}
              </h4>
              <p style={{ fontSize: '0.8125rem', color: '#7A9484', lineHeight: 1.5, marginBottom: '1.5rem' }}>
                {t('solarPossibilitiesDesc')}
              </p>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', background: 'rgba(255,255,255,0.03)', padding: '0.75rem 1rem', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.05)' }}>
                  ...
                  <div>
                    <div style={{ fontSize: '0.8125rem', fontWeight: 700, color: '#ECF2EE' }}>{t('billOffset100')}</div>
                    <div style={{ fontSize: '0.75rem', color: '#7A9484' }}>{t('billOffset100Desc')}</div>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', background: 'rgba(255,255,255,0.03)', padding: '0.75rem 1rem', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.05)' }}>
                  ...
                  <div>
                    <div style={{ fontSize: '0.8125rem', fontWeight: 700, color: '#ECF2EE' }}>{t('govtSubsidy78k')}</div>
                    <div style={{ fontSize: '0.75rem', color: '#7A9484' }}>{t('govtSubsidy78kDesc')}</div>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', background: 'rgba(255,255,255,0.03)', padding: '0.75rem 1rem', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.05)' }}>
                  ...
                  <div>
                    <div style={{ fontSize: '0.8125rem', fontWeight: 700, color: '#ECF2EE' }}>{t('payback3to4yr')}</div>
                    <div style={{ fontSize: '0.75rem', color: '#7A9484' }}>{t('payback3to4yrDesc')}</div>
                  </div>
                </div>
              </div>
            </div>
